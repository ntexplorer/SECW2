...
class QuizGen:
    ...
    def createMCQuiz(self):
        ...
        if (len(self.item) < 5):
            tkinter.messagebox.showerror(title="Error", message="Sorry, less than 5 results were found according to selected category and difficulty")
            raise IndexError
        ...
        self.cur2.execute("INSERT INTO MC_QUIZ (Category, Difficulty, q1Id, q2Id, q3Id, q4Id, q5Id) VALUES (?, ?, ?, ?, ?, ?, ?)", (''.join(self.boxCategory.get()), ''.join(self.boxDifficulty.get()), self.qID[0][0], self.qID[1][0], self.qID[2][0], self.qID[3][0], self.qID[4][0]))
        self.conn2.commit()
        self.conn2.close()
    ...
    def window_ui(self):
        ...
        self.tree3 = ttk.Treeview(self.tab5, column=("column", "colunn1", "colunn2", "colunn3", "colunn4", "colunn5", "colunn6", "colunn7"), show="headings")
        ...
        self.tree4 = ttk.Treeview(self.tab6, column=("column", "colunn1", "colunn2", "colunn3", "colunn4", "colunn5", "colunn6", "colunn7"), show="headings")
