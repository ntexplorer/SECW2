...
class RenderQuestions():
    ...
    def get_question_answer(self):
        ...
        answer_show = self.quiz_list[self.index]['answers']
    ...
    def finish_quiz(self):
        ...
        if if_finish == True:
            ...
            tk.Label(self.question_frame, text='You\'ve got %d answer(s) corrected' % self.correct_answer, font=self.l_style).pack()
